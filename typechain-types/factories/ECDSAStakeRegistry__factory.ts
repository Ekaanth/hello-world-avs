...
export class ECDSAStakeRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): ECDSAStakeRegistryInterface {
    return new Interface(_abi) as ECDSAStakeRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ECDSAStakeRegistry {
    return new Contract(address, _abi, runner) as unknown as ECDSAStakeRegistry;
  }
}
