...
export interface ECDSAStakeRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deregisterOperator"
  ...
  encodeFunctionData(
    ...
    values: [ISignatureUtils.SignatureWithSaltAndExpiryStruct, AddressLike]
  ): string;
  encodeFunctionData(
...
export interface ECDSAStakeRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ECDSAStakeRegistry;
